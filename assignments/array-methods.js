...
}, 0); // <-----THIS IS THE INITIAL VALUE that we want to start with. If we don't declare this, .reduce() will concatenate all of these numbers together as a single string.
